...
class Tree(Plant):
    ...
    def get_info(self) -> None:
        print(f"{self.name}: {self.height}cm, {self.age} days, {self.trunk_diameter}cm diameter")
...
class Vegetable(Plant):
    ...
    def get_info(self) -> None:
        print(f"{self.name}: {self.height}cm, {self.age} days, {self.harvest_season} harvest")
